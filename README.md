...
traditional-engineering ancestor ("you've met this before" — TDD,
RFCs, code review, map-reduce, the Unix philosophy, GTD, the lab
...
- **coding-agents**: `00` one-paste baseline · `01` working agreements ·
  ...
  review · `05` fan-out & orchestration · `06` small tools (incl. stack
...
```
guides/       Canonical guide chapters — guides/<guide-slug>/<chapter>.md
...
database. Raw markdown is served at `/guides/<guide>/*.md`
...
1. **Curation pass** — all three guides and both lists; cut hard. The
